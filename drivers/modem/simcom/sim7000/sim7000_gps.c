...
LOG_MODULE_REGISTER(modem_sim7000_gps, CONFIG_MODEM_LOG_LEVEL);

#include "sim7000.h"

static struct sim7000_gnss_data gnss_data;
...
static int sim7000_start_gnss_ext(bool xtra)
{
	int ret = -EALREADY;
...
coldstart:
	...
	sim7000_change_state(SIM7000_STATE_GNSS);
out:
	return ret;
}
...
{
	return sim7000_start_gnss_ext(false);
}

int mdm_sim7000_start_gnss_xtra(void)
{
	return sim7000_start_gnss_ext(true);
}
